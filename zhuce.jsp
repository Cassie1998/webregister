...
<tr><th height=65><font  size='4'>用 户 名</th><th><input type="text" style="height:40px" placeholder="请输入用户名" size=40 name="userid"></th></tr>
...
<tr><th height=65><font  size='4'>确认密码</th><th><input type="password" style="height:40px" placeholder="请重新输入密码" size=40 id="password1" name="password1"></th></tr>
<tr><th height=65><font  size='4'>公 司</th><th><input type="text" style="height:40px" placeholder="请输入公司" size=40 name="username"></th></tr>
<tr><th height=65><font  size='4'>电话号码</th><th><input type="text" style="height:40px" placeholder="+86" size=40 name="username"></th></tr>
<tr><th height=65><font  size='4'>电 子 邮 箱</th><th><input type="text" style="height:40px" placeholder="请输入电子邮箱" size=40 name="username"></th></tr>
